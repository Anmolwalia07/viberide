...
const areas = {
  'melbourne-cbd': {
    ...
    relatedLinks: [
      ...
      { label: 'Corporate chauffeur', href: '/corporate-chauffeur-melbourne' },
      { label: 'Private chauffeur', href: '/private-chauffeur-melbourne' },
    ],
  },
  southbank: {
    ...
    relatedLinks: [
      { label: 'Melbourne Airport Transfers', href: '/melbourne-airport-transfers' },
      { label: 'Point-to-point chauffeur', href: '/point-to-point-chauffeur' },
  ...
  'south-yarra': {
    ...
    relatedLinks: [
      { label: 'Luxury car with driver', href: '/luxury-car-with-driver-melbourne' },
      { label: 'Hourly chauffeur', href: '/hourly-chauffeur-melbourne' },
      { label: 'Book now', href: '/#quote-form' },
    ],
  },
  toorak: {
  ...
  brighton: {
    ...
    relatedLinks: [
      { label: 'Wedding chauffeur', href: '/wedding-chauffeur-melbourne' },
      { label: 'Private chauffeur', href: '/private-chauffeur-melbourne' },
      { label: 'Book now', href: '/#quote-form' },
    ],
  },
